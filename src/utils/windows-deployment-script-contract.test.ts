...
describe('Windows administrator deployment smoke contracts', () => {
  it('requires the machine-wide desktop authentication callback protocol throughout MSI lifecycle gates', () => {
    ...
    expect(deployment).toContain("[string]$_.fields.callbackUrl -notin @('', '[redacted]')")
    expect(deployment).toContain('$_.fields.callbackUrlLength -eq ([string]$_.fields.callbackUrl).Length')
    expect(deployment).toContain('$_.fields.rawUrlLength -eq ([string]$_.fields.rawUrl).Length')
