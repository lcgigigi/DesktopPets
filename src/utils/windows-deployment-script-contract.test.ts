...
describe('Windows administrator deployment smoke contracts', () => {
  it('requires the machine-wide desktop authentication callback protocol throughout MSI lifecycle gates', () => {
    ...
    expect(deployment).toContain('$rendererDiagnostic.fields.receivedState -eq $authState')
    expect(deployment).toContain('$rendererDiagnostic.fields.expectedState -eq $authState')
    expect(deployment).toContain('$rendererDiagnostic.fields.stateMatches -eq $true')
